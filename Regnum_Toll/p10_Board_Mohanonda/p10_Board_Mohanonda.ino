...
dmd.clearScreen(true);
           ...
           dmd.drawString(  0,  0, "  Mohanonda", 8, GRAPHICS_NORMAL );
        ...
        dmd.clearScreen(true);
         ...
         dmd.drawString(  0,  8, "  5 TK", 8, GRAPHICS_NORMAL );
         //delay(2000);
      }
      else if (data == "d"){
        dmd.clearScreen(true);
       ...
       //  delay(2000);
        ...
        dmd.clearScreen(true);
         ...
         dmd.drawString(  0,  8, " 30 TK", 8, GRAPHICS_NORMAL );
        // delay(2000);
        // dmd.clearScreen(true);
      }
      else if (data == "i"){
        ...
        dmd.clearScreen(true);
         ...
         dmd.drawString(  0,  8, "  75 TK", 8, GRAPHICS_NORMAL );
        // delay(3000);
        // dmd.clearScreen(true);
      }
      else if (data == "k"){
        dmd.clearScreen(true);
         ...
         dmd.drawString(  0,  8, "  50 TK", 8, GRAPHICS_NORMAL );
         //delay(2000);
         //dmd.clearScreen(true);
      }
      else if (data == "l"){
        dmd.clearScreen(true);
         dmd.selectFont(System5x7);
         dmd.drawString(  0,  0, "Medium Truck", 11, GRAPHICS_NORMAL );
         dmd.drawString(  0,  8, "  90 TK", 8, GRAPHICS_NORMAL );
        // delay(2000);
        // dmd.clearScreen(true);
      }
      else if (data == "m"){
        dmd.clearScreen(true);
         dmd.selectFont(System5x7);
         dmd.drawString(  0,  0, "Heavy Truck", 11, GRAPHICS_NORMAL );
         dmd.drawString(  0,  8, "  130 TK", 8, GRAPHICS_NORMAL );
        // delay(2000);
       //  dmd.clearScreen(true);
      }
      else if (data == "n"){
        dmd.clearScreen(true);
         ...
         dmd.drawString(  0,  8, "  375 TK", 8, GRAPHICS_NORMAL );
        // delay(2000);
        // dmd.clearScreen(true);
      }
